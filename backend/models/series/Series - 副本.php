...
class Series extends \yii\db\ActiveRecord
{
    ...
    {
        return Series::find()->select(["username","series_id","series_name","series_sort","series_status","zss_series.updated_at","zss_series.created_at"])
    ...
    {
       return Series::findOne(["series_id"=>$id])->delete();
