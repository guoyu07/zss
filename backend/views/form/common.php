...
<link rel="stylesheet" href="<?php yii::$app->request->baseUrl?>css/colorpicker.css" />
<link rel="stylesheet" href="<?php yii::$app->request->baseUrl?>css/datepicker.css" />
...
<link rel="stylesheet" href="<?php yii::$app->request->baseUrl?>css/bootstrap-wysihtml5.css" />
<link href="font-awesome/<?php yii::$app->request->baseUrl?>css/font-awesome.css" rel="stylesheet" />
...
<script src="<?php yii::$app->request->baseUrl?>js/bootstrap-colorpicker.js"></script>
<script src="<?php yii::$app->request->baseUrl?>js/bootstrap-datepicker.js"></script>
<script src="<?php yii::$app->request->baseUrl?>js/jquery.toggle.buttons.html"></script>
<script src="<?php yii::$app->request->baseUrl?>js/masked.js"></script>
...
<script src="<?php yii::$app->request->baseUrl?>js/matrix.form_common.js"></script>
<script src="<?php yii::$app->request->baseUrl?>js/wysihtml5-0.3.0.js"></script>
<script src="<?php yii::$app->request->baseUrl?>js/jquery.peity.min.js"></script>
<script src="<?php yii::$app->request->baseUrl?>js/bootstrap-wysihtml5.js"></script>
<script>
