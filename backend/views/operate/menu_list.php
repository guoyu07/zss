            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    <a href="<?php echo \Yii::$app->urlManager->createUrl(['operate/menu-detail']) ?>&menu_name=<?= $model['menu_name'] ?>&date=<?= $model['created_at'] ?>&series_name=<?= $model['series_name'] ?>">
...
$(document).ready(function(){
  ...
  $(".laydate").click(function(){
    ...
    $("#small").toggle(function(){
     ...
     $.ajax({
        type : "POST",
        url : "<?php echo Yii::$app->urlManager->createUrl(['operate/menu-search']); ?>",
   ...
   //数据更新
     ...
     if(start_time <= '2016-01-01' || end_time > "<?= $date ?>" || start_time > end_time){
      ...
      $.ajax({
         type : "POST",
         url : "<?php echo Yii::$app->urlManager->createUrl(['operate/menu-creat']); ?>",
   ...
   //excel导出
     ...
     var temp = document.createElement("form");
      temp.action = "<?php echo Yii::$app->urlManager->createUrl(['operate/menu-excel']); ?>";
      temp.method = "post";
...
<div id="menu_line" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
