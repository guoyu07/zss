...
$(document).ready(function(){
  ...
  $(".laydate").click(function(){
    ...
    $("#small").toggle(function(){
     ...
     $.ajax({
         type : "POST",
         url : "<?php echo Yii::$app->urlManager->createUrl(['operate/series-search']); ?>",
   ...
   //数据更新
     ...
     if(start_time <= '2016-01-01' || end_time > "<?= $date ?>" || start_time > end_time){
      ...
      $.ajax({
          type : "POST",
          url : "<?php echo Yii::$app->urlManager->createUrl(['operate/series-creat']); ?>",
   ...
   //excel导出
     ...
     var temp = document.createElement("form");
      temp.action = "<?php echo Yii::$app->urlManager->createUrl(['operate/excel-series']); ?>";
      temp.method = "post";
...
<div id="series" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
