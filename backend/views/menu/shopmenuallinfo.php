        ...
        <div class="widget-content nopadding" >
		  ...
		  <div class="control-group">
              <label class="control-label">
					...
					菜品&nbsp;名称:&nbsp;
					<span id="shop_id"><?= $allinfo["menu_name"]?></span>
...
<div id="left">
	...
	<div class="control-group" style="">
	 ...
	 <div class="control-group">
	  <label for="checkboxes" class="control-label"><button class="btn btn-primary" disabled>原价格</button></label>
	  <div class="controls"  style=" padding-top:20px;">
		<?= $allinfo["menu_price"]?>
	  </div>
	</div>
	 <div class="control-group">
	  <label for="checkboxes" class="control-label"><button class="btn btn-primary" disabled>折扣后售价</button></label>
	  <div class="controls"  style=" padding-top:20px;">
	<?= $allinfo["discount_num"]?>
	  </div>
	</div>

	 <div class="control-group">
	  <label for="checkboxes" class="control-label"><button class="btn btn-primary" disabled>售卖时段</button></label>
	  <div class="controls"  style=" padding-top:20px;">
	<?= $allinfo["menu_desc"]?>
	  </div>
	</div>
...
<div class="control-group">
	  <label class="control-label"><button class="btn btn-primary" disabled>库存</button></label>
	  <div class="controls"  style=" padding-top:20px;">
		<?= $allinfo["stock"]?>
	  </div>
	</div>
	 ...
	 <div class="control-group">
		  ...
		  <div class="controls"  style=" padding-top:20px;">
	<?= $allinfo["menu_introduce"]?>
		  </div>
		</div>
	<div class="control-group">
	  <label for="checkboxes" class="control-label"><button class="btn btn-primary" disabled>状态</button></label>
	  <div class="controls"  style=" padding-top:20px;">
		<?= $allinfo["is_show"]?>
	  </div>
	</div>
