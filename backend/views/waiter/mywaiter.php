...
<!---->
        ...
        <td>
			...
			<input type="checkbox" checked="checked" name="waiter[]" value="<?= Html::encode($value["id"])?>"><?= Html::encode($value["username"])?>
			...
			<input type="checkbox"  name="waiter[]" value="<?= Html::encode($value["id"])?>"><?= Html::encode($value["username"])?>
			...
			<?php  }  ?>
                ...
                <tr>
                	...
                	<td><input name="shopid" type="hidden" value="<?= $shopid ?>" /><input name="_csrf" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken ?>">服务员操作</td>
                	<td><input type="submit" value="添加"></td>
                </tr>

               <?php }?>
                <?php if (empty($allinfo["allinfo"])) { ?>
                  <font color="red">暂时没有门店服务员供选择</font>
                <?php } ?>
