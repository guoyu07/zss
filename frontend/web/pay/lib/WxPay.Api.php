...
//require_once "WxPay.Data.php";
  require_once(Yii::getAlias('@app/web/pay/lib/WxPay.Exception.php'));
  require_once(Yii::getAlias('@app/web/pay/lib/WxPay.Config.php'));
require_once(Yii::getAlias('@app/web/pay/lib/WxPay.Data.php'));
