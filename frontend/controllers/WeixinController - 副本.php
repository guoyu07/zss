...
class WeixinController extends Controller{
		            ...
		            "sub_button": [
		                {
		                    "type":"view", 
		                    "name": "会员中心", 
		                    "url":"http://www.wujiaweb.com/web/index.php?r=mywallet/"
		                }, 
		                {
		                    "type": "click", 
		                    "name": "点餐攻略", 
		                ...
		                }, 
		                {
		                    "type":"view",
		                    "name": "点餐", 
		                    "url":"http://www.wujiaweb.com/web/index.php?r=shop/index/"
		                }
		            ]
		        }, 
		        {
	...
	public function reponseMsg(){
		...
		if( strtolower( $postObj->MsgType ) == 'event'){
              ...
              //$model->insertweixin("$language");

			//$memcache = new Memcache;

			//$memcache->connect("120.27.118.193",11211);

			//$mem->set('username','123123');

               
        switch ($postObj->Event)
        {
            case "subscribe":
                $content = "欢迎进入宅食送微信平台 test";
                break;
				case "CLICK":
