...
class JsApiPay {
    ...
    public function GetOpenData() {
        ...
        if (!isset($_GET['code'])) {
            ...
            //if (!isset($_GET['state']) || !isset($_SESSION['wx_state']) || $_GET['state'] != //$_SESSION['wx_state']) {
             //   exit('非法请求');
            //}
            //unset($_SESSION['wx_state']);
    ...
    public function getUserInfo($access_token, $openid) {
        ...
        $pre_url = 'https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s&lang=zh_CN';
        $url = sprintf($pre_url, $access_token, $openid);
        $res = $this->httpGet($url);
        //取出openid
        $data = json_decode($res, true);
        return $data;
