    ...
    <div class="content">
        ...
        <div style="background:#fff; width:100%;">
            <div style="border-bottom:1px solid #fff; height:40px;">
                ...
                <input  name="AddressForm[username]" style="line-height:25px; width:80%; border:none;outline:none;" value="<?= Html::encode($info[0]["site_name"])?>" />
           ...
           <br/>
            <div style="border-bottom:1px solid #fff; height:40px;">
                ...
                <input name="AddressForm[phone]" style="line-height:25px; width:80%; border:none;outline:none;" value="<?= Html::encode($info[0]["site_phone"])?>">
           ...
           <br/>
            <div style="width:40%; height:40px; margin:0 auto;">
                ...
                <?php if($info[0]["site_sex"]=="女士"){ ?>

                    <input type="radio" name='sex'   value="先生" id="male" style=""/><label for="male" class="check-box" style="float:left;"></label><span style="font-size:12px; line-height:25px;float:left; display:block; margin-left:10px; margin-right:30px; color:#707070;">先生</span>
                    <input type="radio"  name="sex" checked="checked" value="女士" id="female" style=" margin-left:40px;"/><label  for="female" class="check-box" style="float:left;"></label><span style="font-size:12px; line-height:25px;float:left; display:block;  color:#707070;">女士</span>
		...
		<?php 
				...
				$info = explode(",",$info[0]["site_detail"]);
?>
        ...
        <div style="background:#fff; width:100%;">
            <div style="border-bottom:1px solid #fff; height:40px;">
                ...
                <input  name='AddressForm[address]' style="line-height:25px; width:50%; border:none;outline:none;" value="<?= $info[0] 
				?>" >
  ...
  <div style="border-bottom:1px solid #fff; height:40px;">
                ...
                <input name='AddressForm[localnum]' style="line-height:25px; width:50%; border:none; outline:none;" value="<?= $info[1] ?>">
            </div>
        </div>
                     <font style='text-align: center; font-size:12px;color:red'><?= Html::error($model,'localnum')?></font> 
        <button type="submit" style="margin-right:20px; margin-top:10px; float:right; padding:7px 15px; background:#81181d; color:#fff; border:none;">修改</button>
        <?php ActiveForm::end(); ?>
    </div>
</body>
</html>
